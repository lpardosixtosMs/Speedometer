  ...
  return (
      <VerticalPopOver>
          <div className="ui spectrum-Textfield">
              ...
              <input id="textfield-1" type="text" name="field" defaultValue="Sprint one" className="ui spectrum-Textfield-input filter-input"
                     pattern="[\w\s]+" aria-describedby="character-count-6"/>
          </div>
          <Stepper />
          <TagGroup />
