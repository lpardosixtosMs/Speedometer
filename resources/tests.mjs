...
Suites.push({
    ...
    url: "todomvc/architecture-examples/react/dist/mail/index.html",
    async prepare(page) {
        const element = await page.waitForElement(".new-todo");
        element.focus();
        page._frame.contentWindow.todo = page.getElementById('root');
...
Suites.push({
    name: "TodoMVC-React-Spectrum",
    url: "todomvc/architecture-examples/react/dist/spectrum/index.html",
    async prepare(page) {
        const element = await page.waitForElement(".new-todo");
        element.focus();
        page._frame.contentWindow.todo = page.getElementById('root');
...
Suites.push({
    name: "TodoMVC-React-Spectrum-Matching",
    url: "todomvc/architecture-examples/react/dist/spectrum-matching/index.html",
    async prepare(page) {
        const element = await page.waitForElement(".new-todo");
        element.focus();
        page._frame.contentWindow.todo = page.getElementById('root');
