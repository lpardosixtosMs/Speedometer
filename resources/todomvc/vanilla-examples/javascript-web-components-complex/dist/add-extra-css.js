...
additionalStyleSheet.insertRule(`:host([completed="false"]) li {
...
additionalStyleSheet.insertRule(`:host([completed="true"]) li {
    background-color: var(--complex-background-color-completed);
    border-bottom-color: var(--complex-border-bottom-color-completed);
}`);
additionalStyleSheet.insertRule(`:host([completed="false"]) li > div > label {
    color: var(--complex-color-not-completed);
}`);
additionalStyleSheet.insertRule(`:host([completed="true"]) li > div > label {
    color: var(--complex-color-completed);
}`);
additionalStyleSheet.insertRule(`:host([completed="true"]) li > div > :focus,
:host([completed="true"]) li > div > .toggle:focus + label { box-shadow: var(--complex-box-shadow);}`);
