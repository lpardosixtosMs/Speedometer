...
import { ActionGroup } from "./action-group.jsx";
...
export const ReminderPopOver = ({ className }) => {
    ...
    children = children.concat([
        ...
        <div className={classnames("spectrum-Textfield", "spectrum-Textfield--sizeS", "spectrum-Textfield--sideLabel", "is-invalid")}>
            <label for="textfield-sidelabel" className={classnames("spectrum-FieldLabel", "spectrum-FieldLabel--sizeM")}>Task ID</label>
        ...
        <div className={classnames("spectrum-Textfield", "spectrum-Textfield--sizeS", "spectrum-Textfield--sideLabel", "is-invalid")}>
            <label for="textfield-sidelabel" className={classnames("spectrum-FieldLabel", "spectrum-FieldLabel--sizeM")}>Email</label>
            <input id="textfield-s-valid" type="text" name="field" placeholder="Email" class="spectrum-Textfield-input" pattern="[\w\s]+" required/>
        </div>,
        
        <div className={classnames("spectrum-Textfield", "spectrum-Textfield--sizeS", "spectrum-Textfield--sideLabel", "is-invalid")}>
            <label for="textfield-sidelabel" className={classnames("spectrum-FieldLabel", "spectrum-FieldLabel--sizeM")}>Phone</label>
