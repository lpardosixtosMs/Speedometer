...
const ProgressBar = ({ teamNumber, value }) => {
    return (
        <div className={`spectrum-ProgressBar spectrum-Meter--sizeS is-negative analytics-bar team-${teamNumber}-progress`} value={value} role="progressbar" aria-valuenow={value} aria-valuemin="0" aria-valuemax="100">
